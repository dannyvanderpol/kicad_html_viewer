...
`;
  ...
  // src/design/design_object.js
  var DesignObject = class {
    constructor() {
      this.filename = "";
      this.designType = "";
      this.version = "";
    ...
    getValues: function(section) {
      ...
      if (pos > 0) {
        ...
        for (let i = pos; i < section.length - 1; i++) {
          if (section[i] == " " && token == "" || section[i] == '"' && token == " " || section[i] == "(" && token == " ") {
            start = i + 1;
  ...
  // src/graphics/graphics_base.js
  var GraphicsBase = class _GraphicsBase {
    constructor() {
      this.type = _GraphicsBase.name;
      this.layer = "design";
  ...
  var Rectangle = class extends GraphicsBase {
    drawElement(ctx) {
  ...
  // src/design/paper_element.js
  var PaperElement = class extends DesignElement {
    constructor(reference) {
      super(reference);
      this.width = 0;
      this.height = 0;
  ...
  // src/parser/paper_parser.js
  var PaperParser = class extends ParserBase {
    parse(sections) {
  ...
  // src/parser/rectangle_parser.js
  var RectangleParser = class extends ParserBase {
    parse(sections) {
  ...
  // src/design/setup_element.js
  var SetupElement = class extends DesignElement {
    constructor(reference) {
      super(reference);
      this.textSize = 0;
      this.lineWidth = 0;
  ...
  // src/parser/setup_parser.js
  var SetupParser = class extends ParserBase {
    parse(sections) {
  ...
  var Polygon = class extends GraphicsBase {
    drawElement(ctx) {
  ...
  // src/parser/zone_parser.js
  var ZoneParser = class extends ParserBase {
    parse(sections) {
  ...
  var DesignParser = {
    parseFile: async function(filename) {
      ...
      logger.info(logger.LEVEL_PARSER, `[Parser] Parsed design: ${design.designType} ${design.designElements.length} design elements, ${design.graphicsElements.length} graphic elements`);
      ...
      if (sections.length != 1) {
        ...
        for (let section of Sections.getSections(sections[0].substring(1, sections[0].length - 1))) {
          ...
          if (elementParser != null) {
            elementParser.parseSection(
              section,
              design.designType,
              parentType,
              design.getDesignElement("setup"),
              paper
            );
  ...
  var Drawer = {
    ...
    draw: function(ctx, designObject, scale) {
      ...
      const byLayer = designObject.graphicsElements.reduce((acc, obj) => {
