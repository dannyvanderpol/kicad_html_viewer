...
export class KiColors
{
    constructor(designType, showDebug)
    {
        this.showDebug = showDebug;
        this.colors = kiColors[designType];

        // Fixed properties valid for every design
...
const kiColors = {
    ...
    'kicad_sch': {
        ...
        'erc_exclusion': 'rgba(194, 194, 194, 0.800)',
